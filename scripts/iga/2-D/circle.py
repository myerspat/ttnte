...
def evaluate_radius(mesh, patch, radius, tol=1e-8):
    ...
    # Check predicted locations
    assert (np.abs(pred[:-1, :] - points) < tol).all()
...
if __name__ == "__main__":
    ...
    # Refine mesh
    mesh.refine(0, factor=6, degree=3)
    ...
    plt.tight_layout()
    plt.savefig("./figs/circle/circle.png")
    ...
    patch = update_patch(mesh.patches[0], phi)
